        ...
        >
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 md:py-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00809D] focus:border-transparent text-gray-900 placeholder-gray-400"
            />
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xl md:text-2xl font-bold text-[#00809D]">
                {height} {t.onboarding.cm}
              </span>
            </div>
            <input
              type="range"
              ...
              className="w-full h-3 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-[#00809D]"
            />
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xl md:text-2xl font-bold text-[#FF7601]">
                {weight} {t.onboarding.kg}
              </span>
            </div>
            <input
              type="range"
              ...
              className="w-full h-3 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-[#FF7601]"
            />
            <div className="flex justify-between text-xs md:text-sm text-gray-500 mt-2">
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xl md:text-2xl font-bold text-[#F3A26D]">
            ...
            <input
              ...
              className="w-full h-3 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-[#F3A26D]"
            />
            <div className="flex justify-between text-xs md:text-sm text-gray-500 mt-2">
