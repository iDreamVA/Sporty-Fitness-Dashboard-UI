    ...
    >
      ...
      <div className="flex flex-col items-center justify-center h-80">
        <div className="perspective-1000 mb-8">
          ...
          >
            {/* Front face */}
            <div className="absolute w-full h-full bg-gradient-to-br from-[#51553a]/30 to-[#51553a]/50 border-2 border-[#51553a]/60 rounded-lg flex items-center justify-center"
              style={{ transform: 'translateZ(80px)' }}>
              <span className="text-[#51553a] font-bold">FRONT</span>
            </div>

            {/* Back face */}
            <div className="absolute w-full h-full bg-gradient-to-br from-[#51553a]/20 to-[#51553a]/30 border-2 border-[#51553a]/40 rounded-lg flex items-center justify-center"
              style={{ transform: 'translateZ(-80px) rotateY(180deg)' }}>
              <span className="text-[#51553a]/70 font-bold">BACK</span>
            </div>

            {/* Top face */}
            <div className="absolute w-full h-full bg-gradient-to-br from-[#51553a]/25 to-[#51553a]/35 border-2 border-[#51553a]/50 rounded-lg"
        ...
        <div className="grid grid-cols-3 gap-4 w-full">
          <div className="bg-gray-100 dark:bg-zinc-800/50 rounded-lg p-4 text-center">
            ...
            <p className="text-[#51553a] text-xl font-bold">{pitch.toFixed(1)}°</p>
          </div>
          <div className="bg-gray-100 dark:bg-zinc-800/50 rounded-lg p-4 text-center">
            <p className="text-gray-500 dark:text-zinc-400 text-sm mb-1">Roll</p>
            <p className="text-[#51553a] text-xl font-bold">{roll.toFixed(1)}°</p>
          </div>
          <div className="bg-gray-100 dark:bg-zinc-800/50 rounded-lg p-4 text-center">
            <p className="text-gray-500 dark:text-zinc-400 text-sm mb-1">Yaw</p>
            <p className="text-[#51553a] text-xl font-bold">{yaw.toFixed(1)}°</p>
          </div>
        </div>
      </div>
    </motion.div>
